          ...
          <div class="custom-modal-overlay-two">
            <div class="custom-modal">
              ...
              <div class="credit-logos">
                  <img class="bounce-img" src="./assets/images/creditLogos/CCA_RGB_black_e.jpg">
                  <img class="bounce-img" src="./assets/images/creditLogos/HE_ENG_rgb.png">
                  <img class="bounce-img" src="./assets/images/creditLogos/OAC_Logo_black.jpg">
                  <img class="bounce-img" src="./assets/images/creditLogos/TAC_FCOT_logo.jpg">
                  <a class="bounce-img" href="https://yigit.world/" target="_blank"> 
                    <span class="yigit-credit"> 
                        Website design and development by Yigit Toprak
                    </span>
                    <img src="./assets/images/creditLogos/walkingDuck.gif" style="width: 50%;">
                  </a> 
              </div>
            </div>
          </div>
